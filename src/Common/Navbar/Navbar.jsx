...
const Navbar = () => {
    ...
    return (
        <nav className={`navbar sticky top-0 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-gradient-to-r from-blue-700 via-purple-600 to-pink-600 text-white'} shadow-lg w-full px-4 lg:px-8 z-50`}>
