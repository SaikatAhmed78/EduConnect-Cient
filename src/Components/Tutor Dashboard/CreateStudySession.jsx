    ...
    return (
        <div className="relative max-w-5xl mx-auto p-8 rounded-lg shadow-xl">
            ...
            <div className="relative z-10">
                ...
                <p className="w-3/4 mx-auto">A beautiful mindset is essential for learning. There's still so much for us to learn. Through studying.</p>
                    ...
                    <div>
                        ...
                        {imageURL && (
                            <div className="mt-4">
                                ...
                                <img src={image} alt="Preview" className="w-32 h-32 object-cover mt-2" />
                            </div>
                        )}
                    </div>
